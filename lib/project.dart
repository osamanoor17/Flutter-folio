      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              projetCard(
                  'FLUTTER', 'Portfolio App', 'My Portfolio App', '10'),
              projetCard('JAVA', 'Covid Ratio', 'App for Covid 19', '9'),
              projetCard('PYTHON', 'Face Recognition',
                  'Attendance using face detection.', '8'),
              projetCard('C++', 'Chess', 'Multiplayer chess engine.', '7'),
              projetCard(
                  'FLUTTER', 'Calculator-Ios', 'Ios calculator', '10')
            ],
          ),
        ),
      ),
